      ...
      <div id="background_popup">
        <form id="popup_connexion">
            ...
            <div id="info_connexion">
                ...
                <input class="input_connexion" type="text" placeholder="Nom d'utilisateur">
                <input class="input_connexion" type="password" placeholder="Mot de passe">
