        ...
        <div id="left_side">
            <ul id="ul_cat">
                ...
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('feed.show', ['id' => Auth::user()->idcompte]) }}">Home</a></p>
                </li>
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('explore', ['id' => Auth::user()->idcompte]) }}">Explore</p></a>
                </li>
                <li class="li_cat hov_but">
                ...
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('compte.show', ['id' => Auth::user()->idcompte]) }}">Profile</a></p>
                </li>
                <li class="li_cat hov_but">
