...
<body>
    <div class="container">
        <div id="left_side">
            <ul id="ul_cat">
                <li class="li_cat hov_but" style="font-size: 250%;"><a href="{{ route('feed.show', ['id' => $compte->idcompte]) }}">&Xopf;</a></li>
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('feed.show', ['id' => $compte->idcompte]) }}">Home</a></p>
                </li>
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('explore', ['id' => $compte->idcompte]) }}">Explore</p></a>
                </li>
                <li class="li_cat hov_but">
                ...
                <li class="li_cat hov_but">
                    ...
                    <p><a href="{{ route('compte.show', ['id' => $compte->idcompte]) }}">Profile</a></p>
                </li>
                <li class="li_cat hov_but">
            ...
            <div class="hov_but" id="div_compte">
                <a style="height:100%;" href="{{ route('compte.show', ['id' => $compte->idcompte]) }}">
                    <div id="info_compte">
