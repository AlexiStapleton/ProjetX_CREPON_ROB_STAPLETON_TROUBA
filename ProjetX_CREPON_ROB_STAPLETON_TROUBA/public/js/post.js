        ...
        button.addEventListener('click', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (data.liked){
                        button.querySelector(".svg_but_post").style.fill = "rgb(249, 24, 128)";
                        button.querySelector(".p_info_but").style.color = "rgb(249, 24, 128)";
                    } else {
                        button.querySelector(".svg_but_post").style.fill = "rgb(87, 87, 87)";
                        button.querySelector(".p_info_but").style.color = "rgb(87, 87, 87)";
                    }
                }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    rtButtons.forEach(button => {
        ...
        button.addEventListener('click', async function(e) {
            ...
            const svg = nbrt.parentElement.querySelector('.svg_but_post')
            ...
            try{
                ...
                if (data.success) {
                    ...
                    if (data.liked){
                        console.log(svg)
                        svg.style.fill = "rgb(0, 186, 124)";
                        nbrt.style.color = "rgb(0, 186, 124)";
                    } else {
                        svg.style.fill = "rgb(87, 87, 87)";
                        nbrt.style.color = "rgb(87, 87, 87)";
                    }
                }
